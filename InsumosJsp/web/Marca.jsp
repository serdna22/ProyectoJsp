                ...
                <div class="card-body"> 
                    <form action="MarcaControl?menu=Marca" method="POST">
                        <div class="form-group">
                            <label>ID</label>
                            <input type="number" value="${marcaEditar.getIdMarca()}" name="txtIdMarca" class="form-control" min="1" max="99999999" pattern="^[1-9]" disabled>
                        </div>
                        <div class="form-group">
                            <label>NOMBRE</label>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <c:forEach var="mar" items="${marcaLista}">
                            <tr>
                                <td>${mar.getIdMarca()}</td>
                                <td>${mar.getMarcaNombre()}</td>

                                <td>
                                    <a class="btn btn-warning" href="MarcaControl?menu=Marca&accion=Editar&idEd=${mar.getIdMarca()}">Editar</a>
                                </td>
                                <td>
                                    <a class="btn btn-danger" href="MarcaControl?menu=Marca&accion=Eliminar&idEli=${mar.getIdMarca()}">Eliminar</a>
                                </td>
                            </tr> 
                        </c:forEach>
                    </tbody>
